...
sig
  ...
  val sendArr: ('a, active stream) sock * Word8ArraySlice.slice -> int
  ...
  val sendVecTo: ('a, dgram) sock * 'a sock_addr * Word8VectorSlice.slice
                 -> unit
  val sendArrTo: ('a, dgram) sock * 'a sock_addr * Word8ArraySlice.slice -> unit
  val sendVecTo':
    ('a, dgram) sock * 'a sock_addr * Word8VectorSlice.slice * out_flags
    -> unit
  val sendArrTo':
    ('a, dgram) sock * 'a sock_addr * Word8ArraySlice.slice * out_flags
    -> unit

  (* Sock input operations *)
  val recvVec: ('a, active stream) sock * int -> Word8Vector.vector
  val recvArr: ('a, active stream) sock * Word8ArraySlice.slice -> int
  ...
  val recvVecFrom: ('a, dgram) sock * int -> Word8Vector.vector * 'a sock_addr
